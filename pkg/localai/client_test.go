...
func TestSendRequest(t *testing.T) {
	...
	prompt := "Расскажи что ты вернулся после долгого перерыва, во время которого поучился играть на укулеле. Скажи как ты рад всех видеть и добавь что-нибудь приятное о команде и её участниках. В постскриптуме пожалуйся на размер квоты и попроси увеличить."
